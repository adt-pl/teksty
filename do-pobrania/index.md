...
postImageAlt: Ilustracja Oli Jasionowskiej przedstawiająca sylwetkę kobiety trzymanej za ramię.
postImageSource: yes
postImageSourceText: art. Ola Jasionowska
---
...
-   ### Zin: Potrzebujesz aborcji? Nie jesteś sama! { id="zin-potrzebujesz-aborcji-nie-jestes-sama" }
    ...
    **Zin z najważniejszymi informacjami o aborcji, które możesz znaleść na naszej stronie.** Dzięki niemu poznasz ==odpowiedzi na większość często zadawanych pytań.==

    Publikację, razem z ADT, współtworzyły: Kobiety w Sieci, Women Help Women, Ciocia Basia i Abortion Network Amsterdam. Poradnik jest napisany prostym, zrozumiałym językiem, przyjaznym w odbiorze. Został oparty na doświadczeniach wyżej wymienionych grup oraz na wynikach badań i rzetelnej wiedzy medycznej. Zawiera m.in. wskazówki o tym, jak przygotować się do własnej aborcji farmakologicznej oraz informacje, jak wspierać inne osoby, które potrzebują aborcji lub właśnie przez nią przechodzą. 

    [:fontawesome-solid-file-pdf: Pobierz PDF](./zin/V1-potrzebujesz-aborcji-nie-jestes-sama.pdf){.md-button}

-   ### Zin: Aborcja bez stygmy

    **Poradnik został przygotowany dla mediów** jednak zawarte w nim rady mogą posłużyć wszystkim, którzy chcą mówić i pisać o aborcji rzetelnie, profesjonalnie i ==unikając przy tym stygmatyzującego języka.==
        
    [:fontawesome-solid-file-pdf: Pobierz PDF](./zin/V1-aborcja-bez-stygmy-poradnik.pdf){.md-button}
...
-   ### Zin: Samopomoc i DIY { id="zin-samopomoc-DIY" }
    ...
    **Tekst kolektywu Dzień Po dotyczący antykoncepcji awaryjnej** jednak zawarte w nim rady mogą posłużyć wszystkim, którzy chcą mówić i pisać o aborcji rzetelnie, profesjonalnie i ==unikając przy tym stygmatyzującego języka.==
        
    [:fontawesome-solid-file-pdf: Pobierz PDF](./zin/V1-samopomoc-diy.pdf){.md-button}

-   ### Zin: Dlaczego nie odeszła wcześniej? { id="zin-cpk-dlaczego-nie-odeszla-wczesniej" }

    **Tekst dla mediów piszących o przemocy domowej**
        
    [:fontawesome-solid-file-pdf: Pobierz PDF](./zin/V1-cpk-dlaczego-nie-odeszla-wczesniej.pdf){.md-button}

</div>

## Grafiki, projekty wlep i plakaty do pobrania { id="grafiki-plakaty-wlepy" }

<div class="cards grid" markdown>

-   Tymczasowy zbiór części naszych grafik (niedługo będzie tego więcej):

    [:material-folder-google-drive: Otwórz Google Drive](https://drive.google.com/drive/folders/1d-DirhDkdSLhbQt-Ll39xCVDRp9Y4VzN){.md-button}
