...
## Aborcja dla wszystkich kobiet { id="aborcja-dla-wszystkich-kobiet" }
...
## Francja – aborcja na okładce Nouvel Observateur { id="francja-nouvel-observateur" }

Dwa miesiące wcześniej na podobny ruch zdecydował się francuski ruch kobiecy – okładka „Nouvel Observateur” zapowiadała „Manifest 343 zdzir” - poczytaj u nas o tej [historii aborcyjnej rewolucji we Francji](../historia/rocznica-francuskiego-manifestu-343″-historia-aborcji-i-mrocznej-roli-simone-vail.md).
...
## Historia aborcji – kryminalizujące prawo aborcyjne w Niemczech { id="niemcy-historia" }
...
## Manifest niemieckich aborcjonistek po polsku: { id="manifest-niemieckich-aborcjonistek" }
