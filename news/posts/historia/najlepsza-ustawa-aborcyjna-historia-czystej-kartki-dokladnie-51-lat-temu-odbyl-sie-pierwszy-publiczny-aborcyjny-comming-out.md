...
postImage: yes
postImagePath: /news/assets/images/nyc-speakout-abortion.jpeg
postImageHeight: 50%
postImageAlt: >-
...
# Najlepsza ustawa aborcyjna, czyli historia "białej kartki" { id="historia-bialej-kartki" }
...
## Mężczyźni mówiący o aborcji zamiast kobiet { id="glos-lucindy-cisler" }
...
## Kobiety zorganizowały własne posiedzenie na temat aborcji { id="kolektyw-redstockings" }
...
## Pierwszy zbiorowy publiczny aborcyjny comming out { id="aborcyjny-coming-out" }
...
**Materiały źródłowe:** [redstockings.org](https://www.redstockings.org/index.php/redstockings-manifesto-authorship)