...
# Ofiary zakazu aborcji w Polsce { id="ofiary-zakazu-aborcji-w-polsce" }

<!-- more -->

Przypominamy: 

## 2004 - Agata Lamczak { id="agata-lamczak" }
...
## 2007 - Alicja Tysiąc { id="alicja-tysiac" }

Tę historię opisałam w tekście powyżej.

## 2008 - 14-letnia Agata z Lublina { id="agata-z-lublina" }
...
## Wrzesień 2021 - Izabela z Pszczyny { id="iza-z-pszczyny" }
...
## Styczeń 2022 - Agnieszka z Częstochowy { id="agata-z-czestochowy" }
