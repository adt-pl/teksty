...
links:
  - news/posts/polska/instrukcja-aborcji-z-mownicy-sejmowej-broniarczyk.md
  - news/posts/polska/konferencja-prasowa-komitetu-legalna-aborcja-bez-kompromisow.md

postImage: yes
postImagePath: /news/assets/images/legalna-aborcja-bez-kompromisow/adt-komitet-ustawy-obywatelskiej-2.jpg
postImageHeight: 35% 
...
-   ## Co zakłada projekt ustawy "Legalna aborcja bez kompromisów"? { id="co-zaklada-projekt-ustawy" }

    Cała treść projektu ustawy [dostępna jest do pobrania :fontawesome-solid-file-pdf:](../../assets/pdf/legalna-aborcja-bez-kompromisow/tresc-projektu-ustawy-2021.pdf).
    ...
    ### Po raz pierwszy w ustawie pojawia się aborcja farmakologiczna. { id="aborcja-farmakologiczna" }
    ...
    ### Obowiązek rzetelnej informacji spoczywa na lekarzu { id="obowiazek-rzetelnej-informacji" }
    ...
    ### Dekryminalizacja aborcji { id="dekryminalizacja-aborcji" }
    ...
    - uchylenie zapisów ustawy _o dopuszczalności przerywania ciąży_ tylko przez lekarza z trzech przesłanek

    ### Uzupełnienie badań prenatalnych { id="uzupelnienie-badan-prenatalnych" }

    - rozszerzenie programu badań prenatalnych o bezpłatny test PAPP-A oraz hormonu β-hCG dla wszystkich osób w ciąży 

    ### Objęcie osób niepełnoletnich szczególną ochorną { id="osoby-niepelnoletnie" }
...
### Czas, aby państwo wzięło odpowiedzialność za osoby przerywające ciąże { id="odpowiedzialnosc-w-rekach-panstwa" }
...
### Należy zatrzymać kryminalizację aborcji i zawstydzanie kobiet { id="koniec-kryminalizacji-i-wstydu" }
...
Możecie korzystać historii zamieszczonych na naszej stronie w zakładce ["Miałam aborcję"](../../../mialam-aborcje/index.md). Jest ich ponad sto, więc jeśli zastanawiacie się, które wydrukować, to polecamy nasz [subiektywny wybów](../../../mialam-aborcje/subiektywny-wybor.md)

#### Skąd czerpać wiedzę o aborcji? { id="skad-czerpac-wiedze-o-aborcji" }

Na początek warto przeczytać poradnik [Jak mówić o aborcji bez stygmy](../../../do-pobrania/index.md/#zin-aborcja-bez-stygmy). Jeśli zbierasz podpisy w zespole, przeczytajcie go razem! Pogłębioną więdzę na temat dyskursu aborcyjnego znajdziesz również w naszych tekstach o stagmatyzacji: [Czym jest stygma?](../../../edu/stygmatyzacja.md) oraz [Jak przeciwdziałać stygmatyzacji?](../../../edu/normalizowanie.md).

Jednak sama wiedza o tym jak *mówić* o aborcji może nie wystarczyć. Jeśli chcesz być dobrze przygotowana/y możesz zapoznać się z naszymi poradnikami i nformacjami w dziale [aborcja](../../../aborcja/index.md) w którym szczegółówo opisujemy to w jaki sposób można przerwać ciążę.

#### Kto może podpisać się pod projektem ustawy? { id="kto-moze-podpisac-sie-pod-projektem-ustawy" }
...
#### Kto może zbierać podpisy pod projektem ustawy? { id="kto-moze-zbierac-podpisy-pod-projektem-ustawy" }

Każda osoba. Niezależnie od wieku, pochodzenia itd.

#### Gdzie wysłać zebrane podpisy? { id="gdzie-wyslac-zebrane-podpisy" }
