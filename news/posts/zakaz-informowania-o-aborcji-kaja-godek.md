...
tags:
  ...
  - Aborcja
postImage: yes
postImagePath: /news/assets/images/kaja-godek.webp
postImageHeight: 40%
postImageTitle: Kaja Godek na antyaborcyjneji demonstracji Fundacji Życie i Rodzina
postImageAlt: >-
...
## Projekt Kai Godek: zakaz informowania o aborcji { id="projekt-kai-godek" }
...
Jak pokazał najnowszy [raport Aborcji Bez Granic](../abg/aborcja-bez-granic-najnowsze-dane-z-2021-2022.md) to grupy oddolne od lat wynokują w Polsce aborcje. Ponad 40 tysięcy osób przerwało niechcianą ciążę w ciągu drugiego roku po wyroku na kobiety pseudo-TK.

## Czemu Kaja Godek chce zakazać informowania o aborcji? { id="czemu-kaja-godek-chce-zakazac-informowania-o-aborcji" }

Kaja Godek wie o tym, że [wiedza na temat tego jak bezpiecznie przerwać ciążę](../../../aborcja/index.md) jest najważniejsza:

> po tym, gdy przedstawicielka Legalnej Aborcji w czerwcu z mównicy w Sejmie [przedstawiła instrukcję](../polska/instrukcja-aborcji-z-mownicy-sejmowej-broniarczyk.md), jak zrobić aborcję domowym sposobem, nasi wolontariusze złożyli zawiadomienie o możliwości popełnienia przestępstwa, jednak prokuratura sprawę umorzyła. Chcemy wprowadzić przepisy, które nie pozwolą na umarzanie takich spraw.
> 
> powiedziała Kaja Godek w wywiadzie dla Rzeczpospolitej

**Dziękujemy Kai Godek za promocję** i upewnianie się, że w wyniku takich obostrzeń, będziemy miały jeszcze więcej pracy, a kobiety (potencjalnie) może nie będą wpadały na oferty szemranych handlarzy, tylko będą _musiały_ skorzystać z pomocy grup oddolnych działających non profit.

Wy też, jak Kaja Godek **możecie nas wesprzeć:** powiedzcie przyjaciółkom o ADT oraz o Aborcji Bez Granic i o aborcyjnym numerze telefonu: 22 29 22 597. Możecie zrobić też trochę więcej niż ona i dorzucić się do [naszej zrzutki](https://zrzutka.pl/adt) oraz wpłacić bezpośrednio na [konto fundacji](../../../zrzutka.md).