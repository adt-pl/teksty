...
title: Rodzicielstwo z wyboru
description: Ciąża, poród i macieżyństwo to wybór, którego każda osoba ma prawo dokonać w zgodzie ze swoimi potrzebami i możliwościami.

template: page.html
tmplOption: extra-head
h1: Macierzyństwo to też wybór
h1Small: jak świadomie zdecydować się na dziecko?
tldr: >-
    ...
    <p>
    <small>Tu znajdziesz parę kwestii związanych z decyzją o nieposiadaniu dzieci, a także inne ważne zagadnienia o macierzyństwie.</small>
postImage: yes
postImagePath: /assets/images/adt-macierzynstwo.jpg
postImageHeight: 50%
postImageAlt: Macierzyństwo czy aborcja?
postImageSource: no
---

# Macierzyństwo to też wybór

## Kobieta, czyli matka { id="spolecznie" }
...
## "Przecież rodzicielstwo jest najwspanialszym darem." { id="wybor" } 
...
## "Jako kobieta spełnisz się tylko w roli matki." { id="kobieta-matka" }
...
## "Ale pomyśl o osobach, które nie mogą mieć dzieci. To strasznie samolubne." { id="kwestia-egoizmu" }
...
## "Kiedyś Ci się zmieni." { id="kiedys-ci-sie-zmieni" }
...
## Dlaczego większość osób robiących aborcję ma już dzieci? { id="aborcje-matek" }
...
## Archetyp *Mater Dolorosa*, czyli parę słów o wychowywaniu dzieci z niepełnosprawnością { id="dzieci-z-niepelnosprawnoscia" }
...
[^3]: [A Majority of People Who Have Abortions Are Already Mothers — Including Mine](https://www.instyle.com/politics-social-issues/mothers-having-abortions-stigma)
[^4]: [Types of Parenting Styles and Effects On Children](https://www.ncbi.nlm.nih.gov/books/NBK568743/)
...
[^7]: [Niepełnosprawność dziecka – jak sobie z nią radzić](https://rampa.net.pl/niepelnosprawnosc-dziecka-jak-sobie-z-nia-radzic/)
[^8]: tutaj przytępny artykuł o objawach, przyczynach i innych niuansach związanych z depresją poporodową: [twarzedepresji.pl/o-depresji-poporodowej/](https://twarzedepresji.pl/o-depresji-poporodowej/)
[^9]: za forsal.pl - [Ile kosztuje wychowanie dziecka do 18 roku życia? Nowe wyliczenia](https://forsal.pl/finanse/finanse-osobiste/artykuly/8429097,koszt-wychowania-dziecka-265-tys-zl-tyle-kosztuje-wychowanie-dziecka-do-18-roku-zycia.html)
